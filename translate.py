...
if __name__ == '__main__':
    translator = Translator("C:\\Users\\shipant\\PycharmProjects\\Language Translation Service\\machine - translation - service\\data")
    sentence = translator.translate("en", "de", "I am a nice person")
    print(sentence)
